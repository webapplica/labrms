...
use App\Commands\Inventory\Profiling\CondemnItem;
...
class CondemnController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('inventory.profile.condemn.create', compact('item', 'currentDate'));
    }
    ...
    {
        $this->dispatch(new CondemnItem($request, $id));
