...
<div class="container-fluid col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6 panel panel-body">
    <legend><h3 class="text-muted">Maintenance Activity: {{ $activity->name }}</h3></legend>

	<ol class="breadcrumb">
	  <li><a href="{{ url('maintenance/activity') }}">Maintenance Activity</a></li>
	  <li class="active">{{ $maintenanceactivity->name }}</li>
	...
	{{ Form::open([
		'method' => 'put', 
		'route' => array('activity.update', $activity->id)
	]) }}
