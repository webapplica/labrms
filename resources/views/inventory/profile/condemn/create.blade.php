...
<div class="container-fluid col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6 panel panel-body panel-padding">
	...
	<legend>
        <h3 class="text-muted pull-left">Item {{ $item->local_id }}: Condemn</h3>
	...
	<ul class="breadcrumb">
		...
		<li class="active">Condemn</li>
	</ul>
		      
	@include('errors.alert')

	{{ Form::open(['method' => 'post', 'url' => url('item/' . $item->id . '/activity/condemn'),  'id' => 'item-form']) }}

		<div class="form-group">
			{{ Form::label('details', 'Details') }}

			<p class="text-muted" style="font-size: 12px;">
				Enter specific details for condemning the item.
			</p>
